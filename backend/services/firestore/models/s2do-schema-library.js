...
exports.S2DOSchemaV1 =
  ...
  exports.S2DOVerificationType =
  exports.S2DOPriority =
  exports.S2DODomain =
  exports.S2DOStem =
    void 0;
...
(function (S2DOVerificationType) {
  ...
  S2DOVerificationType ||
    (exports.S2DOVerificationType = S2DOVerificationType = {})
);
/**
...
const allDomainActions = {
  ...
  [S2DODomain.EXPERIENCE]: [
    ...exports.AmbientContextualActions.filter(
      a => a.domain === S2DODomain.EXPERIENCE
    ),
    ...exports.AmbientSynthesizeActions.filter(
      a => a.domain === S2DODomain.EXPERIENCE
    ),
  ],
...
const allStemDescriptions = Object.assign(
  Object.assign({}, stemDescriptions),
...
function buildS2DOAction(stem, actionDef) {
  return Object.assign(Object.assign({}, actionDef), {
    stem,
