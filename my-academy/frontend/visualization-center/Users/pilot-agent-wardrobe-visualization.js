...
exports.AgentVisualizationManager =
  exports.DressCode =
  exports.EthnicityRepresentation =
  exports.BodyType =
    void 0;
return {
  ...
  variantsToGreet.forEach(variantName => {
    try {
      const greeting = visualizationManager.generateVisualizationCenterGreeting(
        variantName,
        variantName.includes('Middle Eastern')
          ? 'Middle_East'
          : variantName.includes('North African')
            ? 'North_African'
            : variantName.includes('African')
              ? 'African'
              : variantName.includes('Punjabi')
                ? 'South_Asian'
                : ''
      );
      ...
      console.log(
        '- Ethnicity:',
        greeting.physicalPresentation.appearance.ethnicity
      );
      console.log(
        '- Skin Tone:',
        greeting.physicalPresentation.appearance.physicalCharacteristics
          .skinTone
      );
      console.log(
        '- Attire Style:',
        greeting.physicalPresentation.attire.style
      );
    } catch (error) {
...
(function (EthnicityRepresentation) {
  ...
  EthnicityRepresentation ||
    (exports.EthnicityRepresentation = EthnicityRepresentation = {})
);
var DressCode;
(function (DressCode) {
...
class AgentVisualizationManager {
              ...
              culturalAdaptations: [
                {
                  ...
                  modifications: [
                    'cultural_textile_accents',
                    'heritage_inspired_tailoring',
                  ],
                },
              ],
            },
  ...
  getAgentAppearance(agentName) {
    var _a;
    return (_a = this.agentAppearances.get(agentName)) === null || _a === void 0
      ? void 0
      : _a.appearance;
  }
  /**
