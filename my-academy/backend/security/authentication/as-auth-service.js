...
class AuthService {
  ...
  signInWithGoogle() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return yield this.handleSocialAuthResult(
          result.user,
          user_auth_types_1.AuthProvider.GOOGLE
        );
      } catch (error) {
  ...
  signInWithOutlook() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return yield this.handleSocialAuthResult(
          result.user,
          user_auth_types_1.AuthProvider.OUTLOOK
        );
      } catch (error) {
  ...
  signInWithLinkedIn() {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const result = yield (0, auth_1.signInWithPopup)(
          auth,
          linkedinProvider
        );
        return yield this.handleSocialAuthResult(
          result.user,
          user_auth_types_1.AuthProvider.LINKEDIN
        );
      } catch (error) {
  ...
  signInWithEmail(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const result = yield (0, auth_1.signInWithEmailAndPassword)(
          auth,
          email,
          password
        );
  ...
  registerWithEmail(email, password, displayName) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const result = yield (0, auth_1.createUserWithEmailAndPassword)(
          auth,
          email,
          password
        );
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'users', result.user.uid),
          Object.assign(Object.assign({}, userProfile), {
