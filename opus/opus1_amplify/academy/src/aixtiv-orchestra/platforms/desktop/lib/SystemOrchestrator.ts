  ...
  async setupOnboardingFlows(): Promise<void> {
    try {
      ...
      await this.createOnboardingFlow({
        ...
        owner: 'Dr.Grant',
        securityLevel: 'SAO-UR',
        steps: ['identityVerification', 'securityClearance', 'biometricSetup', 'physicalKeyDistribution']
      })
      ...
      await this.createOnboardingFlow({
        ...
        securityLevel: 'Level-3',
        steps: ['identityVerification', 'securityClearance', 'biometricSetup']
      })
      ...
      await this.createOnboardingFlow({
        ...
        securityLevel: 'Level-2',
        steps: ['identityVerification', 'contentAccessSetup', 'biometricSetup']
      })
      ...
      await this.createOnboardingFlow({
        ...
        steps: ['identityVerification', 'academyAccessSetup']
      })
    } catch (error) {
