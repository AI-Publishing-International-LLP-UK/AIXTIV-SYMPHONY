...
var errorMessage = function errorMessage(invalidProp) {
  return "This element does not support ARIA roles, states and properties. Try removing the prop '".concat(
    invalidProp,
    "'."
  );
};
    ...
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        var _nodeAttrs$reserved = nodeAttrs.reserved,
          isReservedNodeType =
            _nodeAttrs$reserved === void 0 ? false : _nodeAttrs$reserved;
