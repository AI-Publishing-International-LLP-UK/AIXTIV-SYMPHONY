...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (window.sallyPortAuth) {
    ...
    console.error('SallyPortAuth is not initialized. Make sure SallyPort is properly configured.');
  }
  ...
  // Sidebar icons data
  const sidebarIcons = [
    { id: 'Communication', name: 'Communication', desc: 'Automated Communication', iconName: 'message-square' },
    { id: 'Growth', name: 'Growth', desc: 'Growth Revenues', iconName: 'target' },
    { id: 'Services', name: 'Services', desc: 'Client Services Innovation', iconName: 'users' },
    { id: 'Automation', name: 'Automation', desc: 'Organizational Automation', iconName: 'code' },
    { id: 'ROI', name: 'ROI', desc: 'ROI Dashboard', iconName: 'share-2' },
    { id: 'Wish', name: 'Wish', desc: 'Your Wish', iconName: 'book-open' },
    { id: 'Academy', name: 'Academy', desc: 'Learning & Training', isTriangle: true, iconName: 'user' }
  ];
