...
class DrMatchLinkedInConnector {
    ...
    /**
     * Initialize connection with GCP-stored credentials
     */
    async initialize() {
        try {
            console.log('🔐 Loading Dr. Match LinkedIn credentials from GCP...');
            
            // Get credentials from GCP Secret Manager - different secret name
