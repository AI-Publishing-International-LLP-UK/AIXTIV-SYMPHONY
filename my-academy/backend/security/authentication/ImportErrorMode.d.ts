...
export type ImportErrorModeOnErrorEnum =
  (typeof ImportErrorModeOnErrorEnum)[keyof typeof ImportErrorModeOnErrorEnum];
/**
...
export declare function ImportErrorModeFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): ImportErrorMode;
export declare function ImportErrorModeToJSON(
  value?: ImportErrorMode | null
): any;
