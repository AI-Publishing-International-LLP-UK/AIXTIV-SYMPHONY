...
export const AutonomyCapabilityMap: Record<AIAutonomyLevel, SystemCapability[]> = {
  [AIAutonomyLevel.SUPERVISED]: [SystemCapability.USER_INTERACTION, SystemCapability.API_CALLS],
  ...
  [AIAutonomyLevel.RESTRICTED]: [SystemCapability.USER_INTERACTION]
}
...
export interface AiRightsConfig {
  ...
  operationalBoundaries: {
    ...
    /** Notebook Infrastructure configuration */
