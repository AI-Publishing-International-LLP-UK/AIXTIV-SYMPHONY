...
export const createConfidenceProfile = functions.https.onCall({
  ...
  try {
    ...
    const profile: Omit<ConfidenceProfile, 'createdAt' | 'updatedAt'> & {
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error creating confidence profile: ' + (error as Error).message
    );
  }
});
...
export const getConfidenceProfile = functions.https.onCall({
  ...
  try {
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error getting confidence profile: ' + (error as Error).message
    );
  }
});
...
export const updateConfidenceMetrics = functions.https.onCall({
  ...
  try {
    ...
    const profile = profileDoc.data() as ConfidenceProfile;
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error updating confidence metrics: ' + (error as Error).message
    );
  }
});
...
export const createInteractionLog = functions.https.onCall({
  ...
  try {
    ...
    const interactionLog: Omit<InteractionLog, 'createdAt' | 'updatedAt'> & {
      createdAt: admin.firestore.FieldValue;
      updatedAt: admin.firestore.FieldValue;
    } = {
      id: interactionId,
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error creating interaction log: ' + (error as Error).message
    );
  }
});
...
export const addInteractionResponse = functions.https.onCall({
  ...
  try {
    ...
    const interactionLog = interactionDoc.data() as InteractionLog;
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error adding interaction response: ' + (error as Error).message
    );
  }
});
...
export const createVerificationRecord = functions.https.onCall({
  ...
  try {
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error creating verification record: ' + (error as Error).message
    );
  }
});
...
export const getVerificationRecords = functions.https.onCall({
  ...
  try {
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error getting verification records: ' + (error as Error).message
    );
  }
});
...
export const completeValidationCheckpoint = functions.https.onCall({
  ...
  try {
    ...
    throw new functions.https.HttpsError(
      'internal',
      'Error completing validation checkpoint: ' + (error as Error).message
    );
  }
});