...
export declare function ListImportsResponseFromJSON(
  json: any
): ListImportsResponse;
export declare function ListImportsResponseFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): ListImportsResponse;
export declare function ListImportsResponseToJSON(
  value?: ListImportsResponse | null
): any;
