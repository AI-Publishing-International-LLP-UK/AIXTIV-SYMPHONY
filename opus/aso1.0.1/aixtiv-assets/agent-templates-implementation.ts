...
export class ProactiveAgent {
   ...
   * @private
   */
  protected async analyzeInitiativeOpportunity(
    context: any
   ...
   * @private
   */
  protected async addWorkflowBoundaries(
    message: string,
    context: any
  ): Promise<string> {
    const boundaries =
   ...
   * @private
   */
  protected async createBaseCompletionMessage(
    context: any,
   ...
   * @private
   */
  protected async createBaseNextStepsMessage(
    context: any,
    nextSteps: any[]
  ): Promise<string> {
