...
exports.ImportErrorModeToJSON =
  exports.ImportErrorModeFromJSONTyped =
  exports.ImportErrorModeFromJSON =
  exports.instanceOfImportErrorMode =
...
function ImportErrorModeFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    onError: !(0, runtime_1.exists)(json, 'onError')
      ? undefined
      : json['onError'],
  };
}
