 ...
 */
export interface CareerStyleReference {
  technicalOrientation: number;
  analyticalOrientation: number;
  creativeOrientation: number;
  socialOrientation: number;
  leadershipOrientation: number;
  structuralOrientation: number;
  primaryStyle: string;
 ...
 */
export interface LeadershipApproachReference {
  strategicThinking: number;
  operationalExecution: number;
  tacticalImplementation: number;
  interpersonalDynamics: number;
 ...
 */
export interface CareerExpertiseProfile {
  id: string;
  userId: string;
  careerStyleReference: CareerStyleReference;
  leadershipApproachReference: LeadershipApproachReference;
  careerAttributes: {
    industries: {
 ...
 */
export interface CareerBenchmarkResults {
  overall: {
    percentile: number;
    peerCount: number;
  };
...
class CareerExpertiseService {
  ...
  async createCareerProfile(params: {
    userId: string;
    careerStyleInputs?: Record<string, any>;
    leadershipApproachInputs?: Record<string, any>;
    industries?: {
      primary: IndustryCategory;
      secondary: IndustryCategory;
      experience: Record<string, number>;
  ...
  async getCareerBenchmarks(params: {
    ...
    success: boolean;
    profileId?: string;
    benchmarks?: CareerBenchmarkResults;
    message?: string;
  }> {
