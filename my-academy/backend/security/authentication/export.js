...
var _builder = require('../exportMap/builder');
var _builder2 = _interopRequireDefault(_builder);
var _patternCapture = require('../exportMap/patternCapture');
var _patternCapture2 = _interopRequireDefault(_patternCapture);
      ...
      return {
          ...
          function ExportNamedDeclaration(node) {
            ...
            if (node.declaration.declarations != null) {
              ...
              try {
                for (
                  var _iterator =
                      node.declaration.declarations[Symbol.iterator](),
                    _step;
        ...
        ExportAllDeclaration: (function () {
          function ExportAllDeclaration(node) {
            ...
            var remoteExports = _builder2['default'].get(
              node.source.value,
              context
            );
            ...
            if (!any) {
              context.report(
                node.source,
                "No named exports found in module '" +
                        ...
                        if (name === 'default') {
                          ...
                          context.report(
                            ...
                            "Multiple exports of name '" +
                              String(name.replace(tsTypePrefix, '')) +
                              "'."
                          );
                        }
                      }
