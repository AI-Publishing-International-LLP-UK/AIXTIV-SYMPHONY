  ...
  create: (function () {
    function create(context) {
        ...
        if (
          ...
          context.report({
            ...
            message:
              ...
              ' after ' +
              String(type) +
              ' statement not followed by another ' +
              String(type) +
              '.',
            fix:
      ...
      function checkImport(node) {
        ...
        if (
          typeof parent.comments !== 'undefined' &&
      ...
      return {
        ...
        'Program:exit': (function () {
          function ProgramExit(node) {
            log(
              'exit processing for',
              (0, _contextCompat.getPhysicalFilename)(context)
            );
            var scopeBody = getScopeBody(
              (0, _contextCompat.getScope)(context, node)
            );
            ...
            requireCalls.forEach(function (node, index) {
              ...
              if (
                ...
                var nextComment = void 0;
                if (
                  typeof statementWithRequireCall.parent.comments !==
                    'undefined' &&
                  options.considerComments
                ) {
                  var endLine = node.loc.end.line;
