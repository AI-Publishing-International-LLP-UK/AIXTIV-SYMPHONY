...
export declare function StartImportRequestFromJSON(
  json: any
): StartImportRequest;
export declare function StartImportRequestFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean
): StartImportRequest;
export declare function StartImportRequestToJSON(
  value?: StartImportRequest | null
): any;
