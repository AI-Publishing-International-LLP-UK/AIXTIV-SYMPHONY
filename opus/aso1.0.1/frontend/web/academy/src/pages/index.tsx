...
import {
  useStore,
  useAcademyStore,
} from '../../../../e-commerce/store/StoreContext';
    ...
    >
      ...
      {!isAuthenticated ? (
        ...
        >
          ...
          <p>
            You have successfully authenticated and can now access all academy
            content.
          </p>
            ...
            <ul style={{ listStyleType: 'none', padding: 0 }}>
              ...
              >
                <h4 style={{ margin: '0 0 10px 0' }}>
                  Introduction to AIXTIV Symphony
                </h4>
                <p style={{ margin: 0 }}>
                  Learn the basics of the AIXTIV Symphony platform and its
                  capabilities.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p style={{ margin: 0 }}>
                  Master the visualization center and create immersive
                  experiences.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p style={{ margin: 0 }}>
                  Connect your learning journey with the Dr. Memoria Anthology
                  system.
                </p>
              </li>
            </ul>
