...
exports.StartImportRequestToJSON =
  exports.StartImportRequestFromJSONTyped =
  exports.StartImportRequestFromJSON =
  exports.instanceOfStartImportRequest =
    void 0;
...
function StartImportRequestFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    integrationId: !(0, runtime_1.exists)(json, 'integrationId')
      ? undefined
      : json['integrationId'],
    uri: json['uri'],
    errorMode: !(0, runtime_1.exists)(json, 'errorMode')
      ? undefined
      : (0, ImportErrorMode_1.ImportErrorModeFromJSON)(json['errorMode']),
  };
}
