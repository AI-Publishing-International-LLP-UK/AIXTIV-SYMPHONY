...
exports.default = util.createRule({
  ...
  create(context, [option]) {
    var _a, _b;
    const prefer =
      (_a = option.prefer) !== null && _a !== void 0 ? _a : 'type-imports';
    const disallowTypeAnnotations = option.disallowTypeAnnotations !== false;
    const fixStyle =
      (_b = option.fixStyle) !== null && _b !== void 0
        ? _b
                  ...
                  if (variable.references.length === 0) {
                    ...
                    const onlyHasTypeReferences = variable.references.every(
                      ref => {
                         ...
                         */
                        if (
                          ((_a = ref.identifier.parent) === null ||
                          _a === void 0
                            ? void 0
                            : _a.type) ===
                            utils_1.AST_NODE_TYPES.ExportSpecifier ||
                          ((_b = ref.identifier.parent) === null ||
                          _b === void 0
                            ? void 0
                            : _b.type) ===
    ...
    function classifySpecifier(node) {
      ...
      const namedSpecifiers = node.specifiers.filter(
        specifier => specifier.type === utils_1.AST_NODE_TYPES.ImportSpecifier
      );
      return {
        defaultSpecifier,
        namespaceSpecifier,
    ...
    function* fixToValueImportDeclaration(fixer, report, sourceImports) {
      ...
      if (valueNamedSpecifiers.length) {
        if (sourceImports.valueOnlyNamedImport) {
          ...
          yield fixer.insertTextBefore(
            node,
            `import {${fixesNamedSpecifiers.typeNamedSpecifiersText}} from ${sourceCode.getText(node.source)};\n`
          );
        }
      }
      yield* fixesNamedSpecifiers.removeTypeNamedSpecifiers;
    ...
    function* fixRemoveTypeSpecifierFromImportDeclaration(fixer, node) {
      ...
      const typeToken = util.nullThrows(
        sourceCode.getFirstTokenBetween(
          importToken,
          (_b =
            (_a = node.specifiers[0]) === null || _a === void 0
              ? void 0
