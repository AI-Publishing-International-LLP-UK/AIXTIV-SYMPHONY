...
async function main() {
  ...
  if (process.argv.includes('--help')) {
    console.log('Usage:');
    console.log('  node 2100-cool-subdomain-manager.js                     # Generate update report for 2100.cool subdomains (dry run)');
    console.log('  node 2100-cool-subdomain-manager.js --apply             # Apply updates to 2100.cool subdomains');
    console.log('  node 2100-cool-subdomain-manager.js --all               # Generate update report for all domains (dry run)');
    console.log('  node 2100-cool-subdomain-manager.js --all --apply       # Apply updates to all domains');
    console.log('  node 2100-cool-subdomain-manager.js --help              # Show this help');
    return;
  }
  ...
  if (processAllDomains) {
    ...
    if (shouldApply) {
      ...
      console.log('To apply these changes, run: node 2100-cool-subdomain-manager.js --all --apply');
    }
  } else {
    ...
    if (shouldApply) {
      ...
      console.log('\nThis was a dry run. No changes were made.');
      console.log('To apply these changes, run: node 2100-cool-subdomain-manager.js --apply');
    }
  }
}
