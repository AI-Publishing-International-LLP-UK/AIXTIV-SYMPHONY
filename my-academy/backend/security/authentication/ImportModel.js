...
exports.ImportModelToJSON =
  exports.ImportModelFromJSONTyped =
  exports.ImportModelFromJSON =
  exports.instanceOfImportModel =
...
function ImportModelFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    ...
    recordsImported: !(0, runtime_1.exists)(json, 'recordsImported')
      ? undefined
      : json['recordsImported'],
