...
exports.ListImportsResponseToJSON =
  exports.ListImportsResponseFromJSONTyped =
  exports.ListImportsResponseFromJSON =
  exports.instanceOfListImportsResponse =
    void 0;
...
function ListImportsResponseFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    data: !(0, runtime_1.exists)(json, 'data')
      ? undefined
      : json['data'].map(ImportModel_1.ImportModelFromJSON),
    pagination: !(0, runtime_1.exists)(json, 'pagination')
      ? undefined
      : (0, Pagination_1.PaginationFromJSON)(json['pagination']),
  };
}
  ...
  return {
    data:
      value.data === undefined
        ? undefined
        : value.data.map(ImportModel_1.ImportModelToJSON),
