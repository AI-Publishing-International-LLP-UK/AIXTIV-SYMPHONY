        ...
        function (n, u, m) {
          (function (b) {
            ...
            b.toByteArray = function (b) {
              ...
              var a = b.length;
              var l =
                '=' === b.charAt(a - 2) ? 2 : '=' === b.charAt(a - 1) ? 1 : 0;
              ...
              2 === l
                ? ((h = (e(b.charAt(a)) << 2) | (e(b.charAt(a + 1)) >> 4)),
                  d(h & 255))
                : 1 === l &&
                  ((h =
                    (e(b.charAt(a)) << 10) |
        ...
        function (n, u, m) {
          (function (b) {
            var e = Object.prototype.toString,
              g =
                'function' === typeof b.alloc &&
                'function' === typeof b.allocUnsafe &&
            ...
            u.exports = function (h, d, a) {
              ...
              if ('ArrayBuffer' === e.call(h).slice(8, -1)) {
                ...
                return g
                  ? b.from(h.slice(d, d + a))
                  : new b(new Uint8Array(h.slice(d, d + a)));
              }
              if ('string' === typeof h) {
                a = d;
      ...
      5: [
        function (n, u, m) {
          function b(f, p, a) {
            ...
            var c = typeof f;
            if ('number' === c) var d = 0 < f ? f >>> 0 : 0;
            else if ('string' === c) {
              if ('base64' === p)
                for (
                  f = (f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, '')).replace(
                    H,
                    ''
                  );
                  0 !== f.length % 4;
              ...
              'Buffer' === f.type && F(f.data) && (f = f.data),
                (d = 0 < +f.length ? Math.floor(+f.length) : 0);
            else
              throw new TypeError(
            ...
            if (b.TYPED_ARRAY_SUPPORT) var k = b._augment(new Uint8Array(d));
            else (k = this), (k.length = d), (k._isBuffer = !0);
            if (b.TYPED_ARRAY_SUPPORT && 'number' === typeof f.byteLength)
              ...
              if (
                ...
                if (b.isBuffer(f))
                  for (p = 0; p < d; p++) k[p] = f.readUInt8(p);
                else for (p = 0; p < d; p++) k[p] = ((f[p] % 256) + 256) % 256;
              else if ('string' === c) k.write(f, 0, p);
          ...
          function w(f) {
            for (var p = [], b = 0; b < f.length; b++) {
              ...
              if (127 >= a) p.push(a);
                ...
                var c = b;
                55296 <= a && 57343 >= a && b++;
                a = encodeURIComponent(f.slice(c, b + 1))
                  .substr(1)
                  .split('%');
                for (c = 0; c < a.length; c++) p.push(parseInt(a[c], 16));
              }
            }
            return p;
          }
          ...
          b.compare = function (f, a) {
            ...
            for (
              var c = f.length, p = a.length, d = 0, k = Math.min(c, p);
              d < k && f[d] === a[d];
              d++
            );
            d !== k && ((c = f[d]), (p = a[d]));
          ...
          b.concat = function (f, a) {
            ...
            var c;
            if (void 0 === a)
              for (c = a = 0; c < f.length; c++) a += f[c].length;
            var p = new b(a),
              d = 0;
              ...
              switch (f) {
                ...
                case 'utf-8':
                  ...
                  for (a = Math.min(this.length, a); b < a; b++)
                    127 >= this[b]
                      ? ((f += k(c) + String.fromCharCode(this[b])), (c = ''))
                  ...
                  return (
                    (b =
                      0 === b && a === this.length
                        ...
                        : x.fromByteArray(this.slice(b, a))),
                    b
                  );
                case 'ucs2':
                case 'ucs-2':
          ...
          b.prototype.inspect = function () {
            ...
            0 < this.length &&
              ((f = this.toString('hex', 0, b).match(/.{2}/g).join(' ')),
              this.length > b && (f += ' ... '));
            return '<Buffer ' + f + '>';
          };
          ...
          b.prototype.write = function (f, b, a, d) {
            if (isFinite(b)) isFinite(a) || ((d = a), (a = void 0));
            else {
              var p = d;
              d = b;
              b = a;
          ...
          b.prototype.copy = function (a, c, d, k) {
            ...
            if (k !== d && 0 !== a.length && 0 !== this.length) {
              ...
              if (1e3 > k || !b.TYPED_ARRAY_SUPPORT)
                for (var f = 0; f < k; f++) a[f + c] = this[f + d];
          ...
          b.prototype.fill = function (a, c, b) {
            ...
            if (b !== c && 0 !== this.length) {
              ...
              if ('number' === typeof a) for (; c < b; c++) this[c] = a;
              else {
                a = w(a.toString());
          ...
          m.write = function (b, e, g, h, d, a) {
            ...
            isNaN(e) || Infinity === e
              ...
              : ((h = Math.floor(Math.log(e) / Math.LN2)),
                1 > e * (l = Math.pow(2, -h)) && (h--, (l *= 2)),
                (e = 1 <= h + w ? e + v / l : e + v * Math.pow(2, 1 - w)),
                2 <= e * l && (h++, (l /= 2)),
                h + w >= q
                  ? ((e = 0), (h = q))
                  : 1 <= h + w
                    ? ((e = (e * l - 1) * Math.pow(2, d)), (h += w))
                    : ((e = e * Math.pow(2, w - 1) * Math.pow(2, d)), (h = 0)));
      ...
      8: [
        function (n, u, m) {
          (function (b) {
            ...
            m.resolve = function () {
              for (
                var a = '', d = !1, h = arguments.length - 1;
                -1 <= h && !d;
                h--
              ) {
      ...
      11: [
        function (n, u, m) {
          ...
          m.encode = function (e) {
            var g = '',
              h = 0 > e ? (-e << 1) + 1 : e << 1;
            do (e = h & 31), (h >>>= 5), 0 < h && (e |= 32), (g += b.encode(e));
            while (0 < h);
            return g;
          };
      ...
      14: [
        function (n, u, m) {
          ...
          b.prototype.add = function (b) {
            ...
            a > d ||
            (a == d && r >= l) ||
            0 >= e.compareByGeneratedPositionsInflated(g, b)
              ? (this._last = b)
              : (this._sorted = !1);
            this._array.push(b);
          };
        ...
        function (n, u, m) {
          ...
          function e(a, b) {
            ...
            e = e
              ...
              .map(d.normalize)
              .map(function (a) {
                return g && d.isAbsolute(g) && d.isAbsolute(a)
                  ? d.relative(g, a)
                  : a;
              });
          ...
          b.prototype.allGeneratedPositionsFor = function (b) {
            ...
            null != this.sourceRoot &&
              (c.source = d.relative(this.sourceRoot, c.source));
            ...
            if (0 <= c) {
              ...
              if (void 0 === b.column)
                ...
                for (
                  b = g.originalColumn;
                  g && g.originalLine === e && g.originalColumn == b;
          ...
          e.fromSourceMap = function (a, b) {
            ...
            c._sourceMapURL = b;
            for (
              var h = a._mappings.toArray().slice(),
              ...
              f.source &&
                ((p.source = w.indexOf(f.source)),
                (p.originalLine = f.originalLine),
                (p.originalColumn = f.originalColumn),
                f.name && (p.name = k.indexOf(f.name)),
                m.push(p));
              r.push(p);
            }
          ...
          e.prototype._parseMappings = function (a, b) {
            for (
              ...
              if (';' === a.charAt(v)) c++, v++, (k = 0);
              else if (',' === a.charAt(v)) v++;
              else {
                y = new g();
                y.generatedLine = c;
                ...
                1 < A.length &&
                  ((y.source = w + A[1]),
                  (w += A[1]),
                  (y.originalLine = e + A[2]),
                  (e = y.originalLine),
                  (y.originalLine += 1),
                  (y.originalColumn = l + A[3]),
                  (l = y.originalColumn),
                  4 < A.length && ((y.name = h + A[4]), (h += A[4])));
                u.push(y);
          ...
          e.prototype._findMapping = function (b, d, c, k, e, g) {
            ...
            if (0 > b[k])
              throw new TypeError(
                'Column must be greater than or equal to 0, got ' + b[k]
              );
              ...
              if (-1 !== c.consumer.sources.indexOf(d.getArg(a, 'source'))) {
                ...
                if (k)
                  return {
                    ...
                    column:
                      k.column +
                      (c.generatedOffset.generatedLine === k.line
                        ? c.generatedOffset.generatedColumn - 1
                        : 0),
                  };
              }
          ...
          h.prototype._parseMappings = function (a, b) {
            ...
            for (var c = 0; c < this._sections.length; c++)
              for (
                ...
                var r = null;
                l.name &&
                  ((r = k.consumer._names.at(l.name)),
                  this._names.add(r),
                  (r = this._names.indexOf(r)));
                l = {
                  source: h,
                  generatedLine:
                    l.generatedLine + (k.generatedOffset.generatedLine - 1),
                  generatedColumn:
                    l.generatedColumn +
                    (k.generatedOffset.generatedLine === l.generatedLine
        ...
        function (n, u, m) {
          ...
          b.fromSourceMap = function (a) {
            ...
            a.eachMapping(function (a) {
              ...
              null != a.source &&
                ((b.source = a.source),
                null != d && (b.source = g.relative(d, b.source)),
                (b.original = {
                  line: a.originalLine,
          ...
          b.prototype.setSourceContent = function (a, b) {
            ...
            null != b
              ? (this._sourcesContents ||
                ...
                (this._sourcesContents[g.toSetString(d)] = b))
              : this._sourcesContents &&
                (delete this._sourcesContents[g.toSetString(d)],
          ...
          b.prototype.applySourceMap = function (a, b, d) {
            ...
            this._mappings.unsortedForEach(function (b) {
              if (b.source === e && null != b.originalLine) {
                ...
                null != k.source &&
                  ((b.source = k.source),
                  null != d && (b.source = g.join(d, b.source)),
                  null != l && (b.source = g.relative(l, b.source)),
                  (b.originalLine = k.line),
                  (b.originalColumn = k.column),
                  null != k.name && (b.name = k.name));
              }
              k = b.source;
          ...
          b.prototype._serializeMappings = function () {
            for (
              ...
              a = x.generatedColumn;
              null != x.source &&
                ((z = this._sources.indexOf(x.source)),
                (k += e.encode(z - n)),
                (n = z),
                (k += e.encode(x.originalLine - 1 - h)),
                (h = x.originalLine - 1),
                (k += e.encode(x.originalColumn - d)),
                (d = x.originalColumn),
                null != x.name &&
                  ((x = this._names.indexOf(x.name)),
                  (k += e.encode(x - m)),
                  (m = x)));
              c += k;
            }
      ...
      18: [
        function (n, u, m) {
          ...
          b.fromStringWithSourceMap = function (d, a, e) {
            function l(a, c) {
              if (null === a || void 0 === a.source) m.add(c);
              else {
            ...
            a.eachMapping(function (a) {
              if (null !== z)
                if (k < a.generatedLine) l(z, c()), k++, (x = 0);
                else {
                  var b = n[v] || '',
              ...
              x < a.generatedColumn &&
                ((b = n[v] || ''),
                m.add(b.substr(0, a.generatedColumn)),
                (n[v] = b.substr(a.generatedColumn)),
                (x = a.generatedColumn));
              z = a;
            }, this);
            ...
            a.sources.forEach(function (b) {
              var c = a.sourceContentFor(b);
              null != c &&
                (null != e && (b = g.join(e, b)), m.setSourceContent(b, c));
            });
            return m;
          };
          b.prototype.add = function (b) {
            ...
            this.walk(function (b, e) {
              ...
              null !== e.source && null !== e.line && null !== e.column
                ? ((n === e.source &&
                  ...
                  (m = !0))
                : m &&
                  (h.addMapping({ generated: { line: d, column: g } }),
                  (n = null),
                  (m = !1));
        ...
        function (n, u, m) {
          ...
          m.computeSourceURL = function (a, d, l) {
            ...
            if (l) {
              ...
              a.path &&
                ((l = a.path.lastIndexOf('/')),
                0 <= l && (a.path = a.path.substring(0, l + 1)));
              d = h(e(a), d);
            }
            return g(d);
          };
        ...
        function (n, u, m) {
          (function (b) {
            ...
            function h(a, b) {
              ...
              return d && /^\/\w:/.test(e)
                ? ((d += '/'),
                  d + x.resolve(c.slice(d.length), b).replace(/\\/g, '/'))
                : d + x.resolve(c.slice(d.length), b);
            }
            function d(a) {
              var b = C[a.source];
              if (!b) {
                var c = E(a.source);
                c
                  ? ((b = C[a.source] = { url: c.url, map: new k(c.map) }),
              ...
              return b &&
                ...
                ? ((c.source = h(b.url, c.source)), c)
                : a;
            }
            function a(b) {
              var c = /^eval at ([^(]+) \((.+):(\d+):(\d+)\)$/.exec(b);
              return c
                ? ((b = d({ source: c[2], line: +c[3], column: c[4] - 1 })),
                  'eval at ' +
                    c[1] +
                    ' (' +
                    b.source +
            ...
            function q(b) {
              ...
              if (c) {
                ...
                var h = d({ source: c, line: f, column: g });
                b = r(b);
              ...
              b.emit = function (c) {
                if ('uncaughtException' === c) {
                  ...
                  if (d && !e) {
                    ...
                    e = v(d);
                    b.stderr._handle &&
                      b.stderr._handle.setBlocking &&
                      b.stderr._handle.setBlocking(!0);
            ...
            y.push(function (a) {
              ...
              var b = '';
              try {
                if (u) u.existsSync(a) && (b = u.readFileSync(a, 'utf8'));
                else {
            ...
            B.push(function (a) {
              ...
              if (!d) return null;
              G.test(d)
                ? ((f = d.slice(d.indexOf(',') + 1)),
                  (f = F(f, 'base64').toString()),
                  (d = a))
                : ((d = h(a, d)), (f = A(d)));
              return f ? { url: d, map: f } : null;
            });
            var I = y.slice(0),
              L = B.slice(0);
            m.wrapCallSite = q;
            ...
            m.install = function (a) {
              ...
              a.retrieveFile &&
                (a.overrideRetrieveFile && (y.length = 0),
                y.unshift(a.retrieveFile));
              a.retrieveSourceMap &&
                (a.overrideRetrieveSourceMap && (B.length = 0),
                B.unshift(a.retrieveSourceMap));
              if (a.hookRequire && !e()) {
                try {
                  var d = n('module');
                } catch (K) {}
                var g = d.prototype._compile;
                g.__sourceMapSupport ||
                  ((d.prototype._compile = function (a, b) {
                    p[b] = a;
                    C[b] = void 0;
