...
export const usePerformanceMonitoring = () => {
  ...
  return {
    ...
    recordHistogram:
      performanceMonitor.recordHistogram.bind(performanceMonitor),
    recordError: performanceMonitor.recordError.bind(performanceMonitor),
    recordAuthPerformance:
      performanceMonitor.recordAuthPerformance.bind(performanceMonitor),
    recordAgentActivation:
      performanceMonitor.recordAgentActivation.bind(performanceMonitor),
    recordIntegrationPerformance:
      performanceMonitor.recordIntegrationPerformance.bind(performanceMonitor),
  };
};
