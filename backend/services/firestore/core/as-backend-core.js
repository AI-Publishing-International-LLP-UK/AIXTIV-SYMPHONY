...
exports.RaysComputeService =
  ...
  exports.UserService =
  exports.GatewayType =
  exports.SecurityTier =
  exports.PerformanceProfile =
    void 0;
...
const aixtivWallet = new ethers_1.ethers.Wallet(
...
class UserService {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const blockchainAddress =
          ...
          (yield this.generateBlockchainAddress());
        ...
        const userDoc = {
          ...
          paymentTerm:
            userData.paymentTerm || types_1.UserType.MONTHLY_SUBSCRIBER,
        ...
        yield this.createBlockchainVerification(
          'user',
          firebaseUser.uid,
          blockchainAddress
        );
  ...
  static getUserById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const userDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'users', id)
        );
        if (!userDoc.exists()) {
          return null;
        }
  ...
  static getUserByEmail(email) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const usersQuery = (0, firestore_1.query)(
          (0, firestore_1.collection)(db, 'users'),
  ...
  static updateUser(id, data) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const updateData = Object.assign(Object.assign({}, data), {
  ...
  static createBlockchainVerification(recordType, recordId, blockchainAddress) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const recordRef = yield (0, firestore_1.addDoc)(
          (0, firestore_1.collection)(db, 'blockchainRecords'),
          blockchainRecord
        );
        return recordRef.id;
      } catch (error) {
  ...
  static logUserTypeChange(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.addDoc)(
          (0, firestore_1.collection)(db, 'activityLogs'),
          logEntry
        );
      } catch (error) {
  ...
  static ensureUserGateways(userId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const userDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'users', userId)
        );
        if (!userDoc.exists()) {
          return;
        }
        ...
        const needsOwnerGateway =
          userData.specializedRoles.includes(
            types_1.UserType.VISIONARY_VOICE
          ) || userData.position === types_1.UserType.LEADER;
        ...
        if (needsOwnerGateway) {
          ...
          const gatewaysQuery = (0, firestore_1.query)(
            (0, firestore_1.collection)(db, 'integrationGateways'),
            (0, firestore_1.where)('ownerType', '==', 'user'),
            (0, firestore_1.where)('ownerId', '==', userId),
            (0, firestore_1.where)('gatewayType', '==', GatewayType.OWNER)
          );
  ...
  static signInWithEmail(email, password) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.updateDoc)(
          (0, firestore_1.doc)(db, 'users', firebaseUser.uid),
          {
  ...
  static getCurrentUser() {
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) => {
        const unsubscribe = (0, auth_1.onAuthStateChanged)(
          auth,
          user =>
  ...
  static generateToken(userId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const generateTokenFn = (0, functions_1.httpsCallable)(
          functions,
          'generateUserToken'
        );
  ...
  static verifyToken(token) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const verifyTokenFn = (0, functions_1.httpsCallable)(
          functions,
          'verifyUserToken'
        );
...
class OrganizationService {
  ...
  static createOrganization(data) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (
          (_a = data.blockchainVerification) === null || _a === void 0
            ? void 0
            : _a.address
        ) {
          orgData.blockchainVerification = data.blockchainVerification;
        } else if (
          data.trackType === types_1.UserType.CORPORATE ||
          ...
          // Create blockchain verification record
          const txId = yield UserService['createBlockchainVerification'](
            'organization',
            orgId,
            blockchainAddress
          );
        ...
        if (
          ...
          yield this.createOrganizationGateways(
            orgId,
  ...
  static getOrganizationById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const orgDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'organizations', id)
        );
        if (!orgDoc.exists()) {
          return null;
        }
  ...
  static addMemberToOrganization(organizationId_1, userId_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function* (organizationId, userId, role = 'member') {
        var _a;
        try {
          // Check if organization exists
          const orgDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'organizations', organizationId)
          );
          if (!orgDoc.exists()) {
          ...
          const memberDocRef = (0, firestore_1.doc)(
            db,
            'organizations',
            organizationId,
            'members',
          ...
          if (memberDoc.exists()) {
            ...
            if (
              ((_a = memberDoc.data()) === null || _a === void 0
                ? void 0
                : _a.role) !== role
            ) {
  ...
  static getOrganizationMembers(organizationId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const membersSnapshot = yield (0, firestore_1.getDocs)(
        ...
        for (const memberDoc of membersSnapshot.docs) {
          ...
          const userDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'users', memberData.userId)
          );
          if (userDoc.exists()) {
            const userData = userDoc.data();
            members.push({
  ...
  static createTeam(organizationId, name, description, leaderId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'teams', teamData.id),
          teamData
        );
        // If leader is provided, add them to the team
        if (leaderId) {
          yield (0, firestore_1.setDoc)(
            (0, firestore_1.doc)(db, 'teams', teamData.id, 'members', leaderId),
            {
              userId: leaderId,
              teamId: teamData.id,
              role: 'leader',
        ...
        return Object.assign(Object.assign({}, teamData), {
          createdAt: firestore_1.Timestamp.now(),
          updatedAt: firestore_1.Timestamp.now(),
        });
      } catch (error) {
...
class AgentService {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (
          ...
          const vectorStoreId = yield this.createAgentVectorStore(
            agentId,
            data.name || 'New Agent'
          );
  ...
  static getAgentById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const agentDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'agents', id)
        );
        if (!agentDoc.exists()) {
          return null;
        }
  ...
  static getAgentsByOwner(ownerType, ownerId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const agentsQuery = (0, firestore_1.query)(
          (0, firestore_1.collection)(db, 'agents'),
          (0, firestore_1.where)('ownerType', '==', ownerType),
  ...
  static grantAgentAccess(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const agentDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'agents', agentId)
        );
        if (!agentDoc.exists()) {
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'agents', agentId, 'access', accessDocId),
          accessData
        );
        return true;
      } catch (error) {
  ...
  static createAgentVectorStore(agentId, agentName) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const vectorStoreRef = (0, firestore_1.doc)(
          db,
          'vectorStores',
          vectorStoreData.id
        );
  ...
  static createAgentNFT(agentId, agentName, ownerType, ownerId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (ownerType === 'user') {
          const userDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'users', ownerId)
          );
          if (userDoc.exists()) {
          ...
          const orgDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'organizations', ownerId)
          );
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'nftTokens', nftData.id),
          nftData
        );
...
class IntegrationGatewayService {
  ...
  static createGateway(data) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const gatewayDocRef = (0, firestore_1.doc)(
          db,
          'integrationGateways',
          gatewayId
        );
        ...
        yield this.createDefaultEndpoints(
          gatewayId,
  ...
  static getGatewayById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const gatewayDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'integrationGateways', id)
        );
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          const gatewayDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'integrationGateways', gatewayId)
          );
          if (!gatewayDoc.exists()) {
            throw new Error('Gateway not found');
          }
          // Check if endpoint already exists
          const endpointsQuery = (0, firestore_1.query)(
            (0, firestore_1.collection)(
              db,
              'integrationGateways',
              gatewayId,
            ...
            (0, firestore_1.where)('endpointPath', '==', path),
            (0, firestore_1.where)('method', '==', method)
          );
          ...
          return Object.assign(Object.assign({}, endpointData), {
            createdAt: firestore_1.Timestamp.now(),
            updatedAt: firestore_1.Timestamp.now(),
          });
        } catch (error) {
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          yield (0, firestore_1.setDoc)(
            (0, firestore_1.doc)(db, 'integrationApiKeys', apiKeyData.id),
            apiKeyData
          );
          return {
            keyId: apiKeyData.id,
  ...
  static validateApiKey(prefix, apiKey) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const apiKeysQuery = (0, firestore_1.query)(
          (0, firestore_1.collection)(db, 'integrationApiKeys'),
          (0, firestore_1.where)('keyPrefix', '==', prefix),
          (0, firestore_1.where)('status', '==', 'active')
        );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        for (const endpoint of commonEndpoints) {
          ...
          const endpointRef = (0, firestore_1.doc)(
            db,
            'integrationGateways',
            gatewayId,
            'endpoints',
...
class ActivityLoggerService {
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          yield (0, firestore_1.setDoc)(
            (0, firestore_1.doc)(db, 'activityLogs', logEntry.id),
            logEntry
          );
        } catch (error) {
  ...
  static getActivityForResource(resourceType_1, resourceId_1) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function* (resourceType, resourceId, limit = 100) {
        try {
          const logsQuery = (0, firestore_1.query)(
            (0, firestore_1.collection)(db, 'activityLogs'),
            (0, firestore_1.where)('resourceType', '==', resourceType),
            (0, firestore_1.where)('resourceId', '==', resourceId)
          );
          ...
          return querySnapshot.docs
            ...
            .sort((a, b) => {
              ...
              const timeA =
                ((_a = a.performedAt) === null || _a === void 0
                  ? void 0
                  : _a.toMillis()) || 0;
              const timeB =
                ((_b = b.performedAt) === null || _b === void 0
                  ? void 0
                  : _b.toMillis()) || 0;
              return timeB - timeA;
            })
...
class ConversationService {
  ...
  static createConversation(title, initiatorType, initiatorId, participants) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'conversations', conversationId),
          conversationData
        );
        // Add participants
        const batch = (0, firestore_1.writeBatch)(db);
        for (const participant of participants) {
          ...
          const participantRef = (0, firestore_1.doc)(
            db,
            'conversations',
            conversationId,
            'participants',
        ...
        yield batch.commit();
        return Object.assign(Object.assign({}, conversationData), {
          createdAt: firestore_1.Timestamp.now(),
          updatedAt: firestore_1.Timestamp.now(),
          participants,
        });
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          const conversationDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 'conversations', conversationId)
          );
          ...
          if (
            senderType === 'agent' ||
            conversationDoc.data().metadata.vectorize
          ) {
            yield this.vectorizeMessage(
              messageId,
              conversationId,
              content,
              senderType,
          ...
          return Object.assign(Object.assign({}, messageData), {
  ...
  static getConversationMessages(conversationId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const messagesQuery = (0, firestore_1.query)(
          (0, firestore_1.collection)(
            db,
            'conversations',
            conversationId,
          ...
          (0, firestore_1.where)('deletedAt', '==', null)
        ...
        return querySnapshot.docs
          ...
          .sort((a, b) => {
            ...
            const timeA =
              ((_a = a.sentAt) === null || _a === void 0
                ? void 0
                : _a.toMillis()) || 0;
            const timeB =
              ((_b = b.sentAt) === null || _b === void 0
                ? void 0
                : _b.toMillis()) || 0;
            return timeA - timeB;
          });
  ...
  static recordMetric(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'performanceMetrics', metricData.id),
          metricData
        );
      } catch (error) {
  ...
  static getMetricsForSubject(
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          let metricsQuery = (0, firestore_1.query)(
            (0, firestore_1.collection)(db, 'performanceMetrics'),
            (0, firestore_1.where)('subjectType', '==', subjectType),
            (0, firestore_1.where)('subjectId', '==', subjectId)
          );
          if (metricType) {
            metricsQuery = (0, firestore_1.query)(
              metricsQuery,
              (0, firestore_1.where)('metricType', '==', metricType)
            );
          }
          ...
          return querySnapshot.docs
            ...
            .filter(metric => {
              ...
              const metricDate =
                ((_a = metric.capturedAt) === null || _a === void 0
                  ? void 0
                  : _a.toDate()) || new Date(0);
            ...
            .sort((a, b) => {
              ...
              const timeA =
                ((_a = a.capturedAt) === null || _a === void 0
                  ? void 0
                  : _a.toMillis()) || 0;
              const timeB =
                ((_b = b.capturedAt) === null || _b === void 0
                  ? void 0
                  : _b.toMillis()) || 0;
              return timeB - timeA;
            })
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          const storageReference = (0, storage_1.ref)(
            storage,
          ...
          if (encrypt) {
            ...
            yield (0, firestore_1.setDoc)(
              (0, firestore_1.doc)(db, 's2doEncryptionKeys', objectId),
              {
                key: encryptionKey,
                objectId,
                ownerType,
          ...
          const downloadURL = yield (0, storage_1.getDownloadURL)(
            storageReference
          );
          ...
          yield (0, firestore_1.setDoc)(
            (0, firestore_1.doc)(db, 's2doObjects', objectId),
            s2doData
          );
          return objectId;
        } catch (error) {
  ...
  static getS2DOObject(objectId, requesterId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const objectDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 's2doObjects', objectId)
        );
        if (!objectDoc.exists()) {
        ...
        if (storedData.encrypted) {
          ...
          const keyDoc = yield (0, firestore_1.getDoc)(
            (0, firestore_1.doc)(db, 's2doEncryptionKeys', objectId)
          );
          if (!keyDoc.exists()) {
...
class RaysComputeService {
    ...
    return __awaiter(
      ...
      function* (
        ...
        try {
          ...
          yield (0, firestore_1.setDoc)(
            (0, firestore_1.doc)(db, 'raysComputeJobs', jobId),
            jobData
          );
  ...
  static getJobStatus(jobId) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const jobDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'raysComputeJobs', jobId)
        );
        if (!jobDoc.exists()) {
  ...
  static getJobsForRequester(requesterId, requesterType, status) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        let jobsQuery = (0, firestore_1.query)(
          (0, firestore_1.collection)(db, 'raysComputeJobs'),
          (0, firestore_1.where)('requesterId', '==', requesterId),
          (0, firestore_1.where)('requesterType', '==', requesterType)
        );
        if (status) {
          jobsQuery = (0, firestore_1.query)(
            jobsQuery,
        ...
        return querySnapshot.docs
          ...
          .sort((a, b) => {
            ...
            const timeA =
              ((_a = a.createdAt) === null || _a === void 0
                ? void 0
                : _a.toMillis()) || 0;
            const timeB =
              ((_b = b.createdAt) === null || _b === void 0
                ? void 0
                : _b.toMillis()) || 0;
            return timeB - timeA;
          });
