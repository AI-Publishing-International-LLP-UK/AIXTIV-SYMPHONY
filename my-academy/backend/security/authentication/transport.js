...
class Http2Transport {
  constructor(
    ...
    this.subchannelAddressString = (0,
    subchannel_address_1.subchannelAddressToString)(subchannelAddress);
    ...
    session.once('goaway', (errorCode, lastStreamID, opaqueData) => {
      ...
      this.trace(
        'connection closed by GOAWAY with code ' +
          errorCode +
          ' and data ' +
          (opaqueData === null || opaqueData === void 0
            ? void 0
            : opaqueData.toString())
      );
  ...
  getChannelzInfo() {
    ...
    const socketInfo = {
      ...
      localFlowControlWindow:
        (_b = this.session.state.localWindowSize) !== null && _b !== void 0
          ? _b
          : null,
      remoteFlowControlWindow:
        (_c = this.session.state.remoteWindowSize) !== null && _c !== void 0
          ? _c
          : null,
    };
    return socketInfo;
  ...
  maybeSendPing() {
    ...
    (_b = (_a = this.keepaliveTimer).unref) === null || _b === void 0
      ? void 0
      : _b.call(_a);
    let pingSendError = '';
    try {
  ...
  createCall(metadata, host, method, listener, subchannelCallStatsTracker) {
    ...
    if (this.channelzEnabled) {
      ...
      eventTracker = {
        addMessageSent: () => {
          ...
          (_a = subchannelCallStatsTracker.addMessageSent) === null ||
          _a === void 0
            ? void 0
        ...
        addMessageReceived: () => {
          ...
          (_a = subchannelCallStatsTracker.addMessageReceived) === null ||
          _a === void 0
            ? void 0
            : _a.call(subchannelCallStatsTracker);
        },
        ...
        onStreamEnd: success => {
          ...
          (_a = subchannelCallStatsTracker.onStreamEnd) === null ||
          _a === void 0
            ? void 0
    ...
    call = new subchannel_call_1.Http2SubchannelCall(
      http2Stream,
      eventTracker,
      listener,
      this,
  ...
  createSession(address, credentials, options, proxyConnectionResult) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (proxyConnectionResult.realTarget) {
        remoteName = (0, uri_parser_1.uriToString)(
          proxyConnectionResult.realTarget
        );
        this.trace(
      ...
      if ('secureContext' in connectionOptions) {
        ...
        if (options['grpc.ssl_target_name_override']) {
          ...
          const originalCheckServerIdentity =
            (_b = connectionOptions.checkServerIdentity) !== null &&
            _b !== void 0
              ? _b
              : tls_1.checkServerIdentity;
          ...
          const authorityHostname =
            (_d =
              (_c = (0, uri_parser_1.splitHostPort)(targetAuthority)) ===
                null || _c === void 0
                ? void 0
                : _c.host) !== null && _d !== void 0
              ? _d
              : 'localhost';
  ...
  connect(address, credentials, options) {
    ...
    if ('secureContext' in connectionOptions) {
      ...
      if (options['grpc.ssl_target_name_override']) {
        ...
        const originalCheckServerIdentity =
          (_a = connectionOptions.checkServerIdentity) !== null && _a !== void 0
            ? _a
            : tls_1.checkServerIdentity;
        connectionOptions.checkServerIdentity = (host, cert) => {
          return originalCheckServerIdentity(sslTargetNameOverride, cert);
        ...
        if ('grpc.http_connect_target' in options) {
          ...
          const targetPath = (0, resolver_1.getDefaultAuthority)(
            (_b = (0, uri_parser_1.parseUri)(
              options['grpc.http_connect_target']
            )) !== null && _b !== void 0
              ? _b
              : {
                  path: 'localhost',
          ...
          connectionOptions.servername =
            (_c =
              hostPort === null || hostPort === void 0
                ? void 0
                : hostPort.host) !== null && _c !== void 0
              ? _c
              : targetPath;
        }
      }
    ...
    return (0, http_proxy_1.getProxiedConnection)(
      address,
      options,
      connectionOptions
