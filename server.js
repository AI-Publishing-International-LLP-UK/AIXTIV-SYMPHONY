...
let authMiddleware;
try {
  const authModule = require('./middleware/authentication');
  // Use the specific authenticateRequest function from the module
  authMiddleware = authModule.authenticateRequest;
