...
class DreamCommanderAuthenticator {
  constructor() {
    this.linkedInService =
      new linkedin_profile_service_1.LinkedInProfileService();
    this.drMatchService =
      new dr_match_profile_service_1.DrMatchProfileService();
    this.uniqueIdGenerator = new unique_id_generator_1.UniqueIdGenerator();
    this.confidenceCalculator =
      new confidence_score_calculator_1.ConfidenceScoreCalculator();
  }
  /**
  ...
  authenticateAgent(context) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const linkedInProfile = yield this.linkedInService.fetchProfileDetails(
          context.ownerSubscriber.linkedInProfile
        );
        const drMatchProfile = yield this.drMatchService.fetchProfileInsights(
