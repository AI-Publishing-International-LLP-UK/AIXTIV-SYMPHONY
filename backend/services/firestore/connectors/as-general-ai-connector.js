  ...
  constructor(options = {}) {
    ...
    if (this.blockchainManager && !this.s2doManager) {
      this.securityManager =
        new blockchain_integration_1.S2DOBlockchainSecurityManager(
          this.blockchainManager
        );
      this.s2doManager = new s2do_1.S2DOManager(
        this.blockchainManager,
        this.securityManager
      );
    } else {
      ...
      try {
        ...
        if (this.options.useCache && params.useCache !== false) {
          ...
          if (cachedResponse) {
            ...
            return Object.assign(Object.assign({}, cachedResponse), {
              cached: true,
            });
          }
        }
        ...
        switch (params.requestType) {
          ...
          case AIRequestType.IMAGE_GENERATION:
            response = yield this.processImageGenerationRequest(
              requestId,
              params
            );
            break;
          case AIRequestType.DREAM_INTERPRETATION:
            response = yield this.processDreamInterpretationRequest(
              requestId,
              params
            );
            break;
          case AIRequestType.MEMORY_ENHANCEMENT:
            response = yield this.processMemoryEnhancementRequest(
              requestId,
              params
            );
            break;
          case AIRequestType.PROFILE_ANALYSIS:
            response = yield this.processProfileAnalysisRequest(
              requestId,
              params
            );
            break;
          case AIRequestType.VISUALIZATION_CREATION:
            response = yield this.processVisualizationCreationRequest(
              requestId,
              params
            );
            break;
          case AIRequestType.MULTIMODAL_ANALYSIS:
            response = yield this.processMultimodalAnalysisRequest(
              requestId,
              params
            );
            break;
  ...
  processCompletionRequest(requestId, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const completionFunction = (0, functions_1.httpsCallable)(
          functions,
          'aiCompletionRequest'
        );
        const result = yield completionFunction({
          model:
            ((_a = params.options) === null || _a === void 0
              ? void 0
              : _a.model) || this.options.defaultModel,
  ...
  processChatRequest(requestId, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const chatFunction = (0, functions_1.httpsCallable)(
          functions,
          'aiChatRequest'
        );
        ...
        return {
          ...
          content:
            data.content ||
            ((_b = data.message) === null || _b === void 0
              ? void 0
              : _b.content),
          format: params.responseFormat || AIResponseFormat.TEXT,
          usage: data.usage,
  ...
  processEmbeddingRequest(requestId, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const embeddingFunction = (0, functions_1.httpsCallable)(
          functions,
          'generateEmbedding'
        );
        const result = yield embeddingFunction({
          model:
            ((_a = params.options) === null || _a === void 0
              ? void 0
              : _a.embeddingModel) || 'text-embedding-small',
        ...
        return {
          ...
          metadata: {
            ...
            indexName:
              (_c = params.options) === null || _c === void 0
                ? void 0
                : _c.indexName,
            namespace:
  ...
  processImageGenerationRequest(requestId, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const imageGenFunction = (0, functions_1.httpsCallable)(
          functions,
          'generateImage'
        );
...
5. Reflective Questions - Provide 2-3 thoughtful questions for the user to consider`;
        ...
        // Call the chat completion Cloud Function
        const dreamFunction = (0, functions_1.httpsCallable)(
          functions,
          'aiChatRequest'
        );
        ...
        if (this.s2doManager && params.userId) {
          try {
            ...
            yield this.s2doManager.createObject(
              'user',
              params.userId,
              s2do_1.S2DOObjectType.DREAM,
              {
                dreamContent,
                interpretation:
                  data.content ||
                ...
                symbols: extractSymbols(
                  data.content ||
                    ((_c = data.message) === null || _c === void 0
                      ? void 0
                      : _c.content)
                ),
                emotions: extractEmotions(
                  data.content ||
                    ((_d = data.message) === null || _d === void 0
                      ? void 0
                      : _d.content)
                ),
              },
              {
                ...
                tags: extractTags(
                  data.content ||
                    ((_e = data.message) === null || _e === void 0
                      ? void 0
                      : _e.content)
                ),
              }
        ...
        return {
          ...
          content:
            data.content ||
            ((_f = data.message) === null || _f === void 0
              ? void 0
              : _f.content),
          ...
          metadata: {
            ...
            interpretationLength: (
              data.content ||
              ((_g = data.message) === null || _g === void 0
                ? void 0
                : _g.content)
            ).length,
            symbols: extractSymbols(
              data.content ||
                ((_h = data.message) === null || _h === void 0
                  ? void 0
                  : _h.content)
            ),
          },
...
5. Memory Triggers - Suggestions for how to recall or revisit this memory`;
            ...
            if (queryResponse.matches && queryResponse.matches.length > 0) {
              relatedMemories = queryResponse.matches.map(match => {
                ...
                return {
                  id: match.id,
                  content:
                    ((_a = match.metadata) === null || _a === void 0
                      ? void 0
                      : _a.content) || 'Unknown memory',
        ...
        // Call the chat completion Cloud Function
        const memoriaFunction = (0, functions_1.httpsCallable)(
          functions,
          'aiChatRequest'
        );
...
5. Networking Strategy - Recommendations for connection building`;
        ...
        // Call the chat completion Cloud Function
        const profileFunction = (0, functions_1.httpsCallable)(
          functions,
          'aiChatRequest'
        );
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const visualizationType =
          ((_a = params.options) === null || _a === void 0
            ? void 0
            : _a.visualizationType) || 'descriptive';
        let systemPrompt = '';
...
The SVG should be visually appealing and accurately represent the user's request.`;
        ...
        if (visualizationType === 'svg') {
          ...
          const svgFunction = (0, functions_1.httpsCallable)(
            functions,
            'generateSVG'
          );
          ...
          const visualizationFunction = (0, functions_1.httpsCallable)(
            functions,
            'aiChatRequest'
          );
        ...
        if (this.s2doManager && params.userId) {
          try {
            ...
            yield this.s2doManager.createObject(
              'user',
              params.userId,
              s2do_1.S2DOObjectType.VISUALIZATION,
              {
  ...
  processMultimodalAnalysisRequest(requestId, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const multimodalFunction = (0, functions_1.httpsCallable)(
          functions,
          'multimodalAnalysis'
        );
  ...
  getFromCache(params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const cacheDoc = yield (0, firestore_1.getDoc)(
          (0, firestore_1.doc)(db, 'aiResponseCache', cacheKey)
        );
        if (!cacheDoc.exists()) {
          return null;
        }
        ...
        const cacheTime =
          ((_a = cachedData.timestamp) === null || _a === void 0
            ? void 0
            : _a.toMillis()) || 0;
  ...
  logRequest(userId, requestId, params, response, isCached) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        yield core_1.ActivityLoggerService.logActivity(
          'user',
          userId,
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'aiRequestLogs', `log_${requestId}`),
          logEntry
        );
      } catch (error) {
  ...
  logRequestError(userId, requestId, params, error) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield (0, firestore_1.setDoc)(
          (0, firestore_1.doc)(db, 'aiRequestErrorLogs', `error_${requestId}`),
          errorLogEntry
        );
      } catch (logError) {
  ...
  recordMetrics(userId, modelType, requestType, processingTime, tokens) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        yield core_1.PerformanceMetricsService.recordMetric(
          'ai_processing_time',
          'ai',
