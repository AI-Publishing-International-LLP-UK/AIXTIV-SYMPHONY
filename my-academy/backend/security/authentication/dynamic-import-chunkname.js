  ...
  create: (function () {
    function create(context) {
      ...
      var _ref = config || {},
        ...
        importFunctions =
          _ref$importFunctions === undefined ? [] : _ref$importFunctions,
      ...
      var _ref2 = config || {},
        ...
        webpackChunknameFormat =
          _ref2$webpackChunknam === undefined
            ? '([0-9a-zA-Z-_/.]|\\[(request|index)\\])+'
            : _ref2$webpackChunknam;

      var paddedCommentRegex = /^ (\S[\s\S]+\S) $/;
      var commentStyleRegex =
      ...
      var chunkSubstrFormat =
        'webpackChunkName: ["\']' + String(webpackChunknameFormat) + '["\'],? ';
            ...
            suggest: [
              {
                ...
                fix: (function () {
                  function fix(fixer) {
                    ...
                    try {
                      for (
                        var _iterator2 = leadingComments[Symbol.iterator](),
                          _step2;
                        !(_iteratorNormalCompletion2 = (_step2 =
                          _iterator2.next()).done);
                        _iteratorNormalCompletion2 = true
                      ) {
                        var _comment = _step2.value;
                        if (chunkSubstrRegex.test(_comment.value)) {
                          var replacement = _comment.value
...

              {
                ...
                fix: (function () {
                  function fix(fixer) {
                    ...
                    try {
                      for (
                        var _iterator3 = leadingComments[Symbol.iterator](),
                          _step3;
                        !(_iteratorNormalCompletion3 = (_step3 =
                          _iterator3.next()).done);
                        _iteratorNormalCompletion3 = true
                      ) {
                        var _comment2 = _step3.value;
                        if (eagerModeRegex.test(_comment2.value)) {
                          var replacement = _comment2.value
