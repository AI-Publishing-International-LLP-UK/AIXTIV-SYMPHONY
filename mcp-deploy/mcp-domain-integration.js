...
const {
  addDomain,
  updateDNSRecords,
} = require('./domain-management/scripts/godaddy-service');
const {
  selectSiteForDomain,
} = require('./domain-management/scripts/site-selector');
    ...
    parameters: {
      ...
      properties: {
        ...
        site_id: {
          type: 'string',
          description:
            'The Firebase site ID (optional - will be selected if not provided)',
        },
      },
      required: ['domain'],
    },
