 ...
 */
export declare function importSPKI<T extends KeyLike = KeyLike>(
  spki: string,
  alg: string,
 ...
 *   {@link https://github.com/panva/jose/issues/210 Algorithm Key Requirements}.
 */
export declare function importX509<T extends KeyLike = KeyLike>(
  x509: string,
  alg: string,
  options?: PEMImportOptions
): Promise<T>;
 ...
 *   {@link https://github.com/panva/jose/issues/210 Algorithm Key Requirements}.
 */
export declare function importPKCS8<T extends KeyLike = KeyLike>(
  pkcs8: string,
  alg: string,
  options?: PEMImportOptions
): Promise<T>;
 ...
 */
export declare function importJWK<T extends KeyLike = KeyLike>(
  jwk: JWK,
  alg?: string,
