...
class RevisionsClient {
  ...
  constructor(opts, gaxInstance) {
    ...
    if (
      (opts === null || opts === void 0 ? void 0 : opts.universe_domain) &&
        ...
        (_b =
          (_a =
            ...
            : opts === null || opts === void 0
              ? void 0
              : opts.universe_domain) !== null && _b !== void 0
          ? _b
          : universeDomainEnvVar) !== null && _c !== void 0
        ? _c
        : 'googleapis.com';
    this._servicePath = 'run.' + this._universeDomain;
    const servicePath =
      (opts === null || opts === void 0 ? void 0 : opts.servicePath) ||
    ...
    const port =
      ...
      staticMembers.port;
    const clientConfig =
      (_d = opts === null || opts === void 0 ? void 0 : opts.clientConfig) !==
        null && _d !== void 0
        ? _d
        : {};
    const fallback =
      (_e = opts === null || opts === void 0 ? void 0 : opts.fallback) !==
        null && _e !== void 0
        ? _e
    ...
    this.revisionsStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          this._protos.google.cloud.run.v2.Revisions,
      this._opts,
      this._providedCustomServicePath
    );
  ...
  listRevisionsStream(request, options) {
    ...
    return this.descriptors.page.listRevisions.createStream(
      this.innerApiCalls.listRevisions,
      request,
      callSettings
    );
  }
