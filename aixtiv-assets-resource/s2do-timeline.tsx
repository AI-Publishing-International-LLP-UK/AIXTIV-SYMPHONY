  ...
  const phases = [
    {
      ...
      color: '#4285F4',
      description:
        'The core verification and authentication capabilities that form the backbone of the S2DO system.',
    ...
    },
    {
      ...
      color: '#EA4335',
      description:
        'The intelligence and creativity layer that enables advanced collaborative capabilities.',
    ...
    },
    {
      ...
      color: '#FBBC05',
      description:
        'Advanced verification, optimization, and automation capabilities across all business domains.',
    ...
    },
    {
      ...
      color: '#34A853',
      description:
        'Full ecosystem integration capabilities enabling seamless operation across business boundaries.',
    ...
    },
    {
      ...
      color: '#673AB7',
      description:
        'Anticipatory and contextual capabilities that operate at the periphery of consciousness.',
    ...
    },
    {
      ...
      color: '#9C27B0',
      description:
        'Consciousness-inspired, quantum-powered, symbiotic, and transdimensional capabilities.',
    ...
    <div className="p-4 max-w-6xl mx-auto bg-gray-50 rounded-lg shadow-lg">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2">
          S2DO System: Unified Timeline
        </h1>
        <p className="text-gray-600">
          All capabilities active and available now across the complete
          ecosystem
        </p>
      </div>
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <p className="mb-2">
          The complete S2DO system has been fully operational since 2055, with
          all capabilities available across all phases. Organizations can now
          implement capabilities from any phase based on their specific
          readiness and needs.
        </p>
          ...
          <div key={phase.id} className="relative mb-8">
            <div className="flex items-start">
              ...
              <div className="ml-6 flex-1">
                ...
                {expandedPhases[phase.id] && (
                  <div
                    className="bg-white p-4 rounded-lg shadow-md border-l-4 ml-2 mb-4"
      ...
      <div className="bg-gray-100 p-4 rounded-lg border border-gray-300">
        ...
        <p>
          In today's environment, organizations can implement capabilities from
          any phase simultaneously, tailored to their specific needs. The S2DO
          system's modular architecture allows for selective adoption while
          maintaining cross-phase compatibility.
        </p>
        <div className="mt-4 flex flex-wrap justify-between">
          <div className="bg-white p-3 rounded shadow-sm border border-gray-200 w-48 mb-3">
            ...
            <div className="text-sm text-gray-600">
              Begin with the capabilities that deliver immediate value
            </div>
          </div>
          <div className="bg-white p-3 rounded shadow-sm border border-gray-200 w-48 mb-3">
            <div className="font-semibold text-blue-800">Mix & Match</div>
            <div className="text-sm text-gray-600">
              Combine capabilities across different phases
            </div>
          </div>
          <div className="bg-white p-3 rounded shadow-sm border border-gray-200 w-48 mb-3">
            ...
            <div className="text-sm text-gray-600">
              Today's implementations work with tomorrow's capabilities
            </div>
          </div>
          <div className="bg-white p-3 rounded shadow-sm border border-gray-200 w-48 mb-3">
