...
const HomePage = () => {
  return (
    <Container maxWidth="lg" className="py-8">
      ...
      <Paper
        elevation={0}
        className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 mb-8 p-8 rounded-xl"
      >
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={8}>
            ...
            >
              Manage your organization's governance, risk, and compliance with
              our integrated dashboard. Built with Material UI and Tailwind CSS
