 ...
 */
exports.helloWorld = functions.region('us-west1').https.onRequest(async (request, response) => {
 ...
 */
exports.updateUserPreferences = functions.region('us-west1').https.onRequest(async (request, response) => {
  // Set CORS headers
  response.set('Access-Control-Allow-Origin', '*');
