...
class PerformanceMonitor {
  constructor(options) {
    ...
    this.options = Object.assign(
      Object.assign({}, PerformanceMonitor.DEFAULT_OPTIONS),
      options
    );
...
const usePerformanceMonitoring = () => {
  ...
  const endTiming = (operationName, dimensions = {}) => {
    ...
    exports.performanceMonitor.recordHistogram(
  ...
  return {
    ...
    startTiming,
    endTiming,
    recordCount: exports.performanceMonitor.recordCount.bind(
      exports.performanceMonitor
    ),
    recordGauge: exports.performanceMonitor.recordGauge.bind(
      exports.performanceMonitor
    ),
    recordHistogram: exports.performanceMonitor.recordHistogram.bind(
      exports.performanceMonitor
    ),
    recordError: exports.performanceMonitor.recordError.bind(
      exports.performanceMonitor
    ),
    recordAuthPerformance:
      exports.performanceMonitor.recordAuthPerformance.bind(
        exports.performanceMonitor
      ),
    recordAgentActivation:
      exports.performanceMonitor.recordAgentActivation.bind(
        exports.performanceMonitor
      ),
    recordIntegrationPerformance:
      exports.performanceMonitor.recordIntegrationPerformance.bind(
        exports.performanceMonitor
      ),
  };
};
